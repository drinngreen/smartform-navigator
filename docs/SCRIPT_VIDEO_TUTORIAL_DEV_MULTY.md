...
| 01:47 | Click sul selettore "Caratteristiche di pericolo (HP)" | Sotto il CER trovi l'elenco completo HP1–HP15 con il significato di ogni classe: selezioni tutte quelle che il rifiuto presenta, perché un rifiuto può averne più di una. Se il CER è pericoloso, quello con l'asterisco, e non indichi nessuna HP il campo diventa rosso. Ricorda: le HP riguardano il rifiuto, le frasi H le sostanze contenute, e l'attribuzione si basa su processo, schede di sicurezza e analisi, non sull'asterisco. | Selettore HP1–HP15 |
