...
export default function DragonMagazzinoPage() {
    ...
    const filteredMovements = stockMovements.filter(m => {
        if (filterDateFrom && m.movement_date < filterDateFrom)
            return false;
        if (filterDateTo && m.movement_date > filterDateTo)
            return false;
        if (filterItemId && m.item_id !== filterItemId)
            return false;
        if (filterCauseId && m.cause_id !== filterCauseId)
            return false;
        return true;
    });
    ...
    return (_jsxs(MNAdminLayout, { title: "Magazzino", subtitle: "Dragon Rifiuti 2 \u2014 Giacenze e movimenti fisici", children: [_jsx(DragonBackButton, {}), _jsxs(Tabs, { defaultValue: "balances", className: "space-y-4", children: [_jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [_jsxs(TabsList, { children: [_jsx(TabsTrigger, { value: "balances", children: "Saldi" }), _jsx(TabsTrigger, { value: "ledger", children: "Ledger Movimenti" }), _jsx(TabsTrigger, { value: "adjustments", children: "Rettifiche" })] }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Button, { variant: scope === undefined ? "default" : "outline", size: "sm", onClick: () => setScope(undefined), children: "Tutti" }), _jsxs(Button, { variant: scope === "WASTE" ? "default" : "outline", size: "sm", onClick: () => setScope("WASTE"), children: [_jsx(Recycle, { className: "h-4 w-4 mr-1" }), " Rifiuti"] }), _jsxs(Button, { variant: scope === "MPS" ? "default" : "outline", size: "sm", onClick: () => setScope("MPS"), children: [_jsx(Package, { className: "h-4 w-4 mr-1" }), " MPS"] })] })] }), _jsxs(TabsContent, { value: "balances", children: [_jsx("div", { className: "flex justify-end mb-3", children: _jsxs(Button, { variant: "outline", size: "sm", onClick: () => {
                                        exportToExcel(balances.map(b => ({
