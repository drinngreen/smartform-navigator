...
import { FileText, Search, RefreshCw, Loader2, Edit, CheckCircle, Clock } from "lucide-react";
...
export default function FormulariPage() {
    ...
    return (_jsxs(AdminLayout, { title: "Formulari", subtitle: "Gestione formulari FIR creati dagli autisti", children: [_jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3 mb-6", children: [
