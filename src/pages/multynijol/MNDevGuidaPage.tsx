    ...
    <MNAdminLayout title="📘 Guida Dev Multy" subtitle="Multyproget · Istruzioni operative complete">
      ...
      <div className="rounded-2xl border border-border/40 bg-card/60 backdrop-blur-xl p-6 md:p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-border/30">
          ...
          <div>
            <h1 className="text-lg font-semibold text-foreground">Guida Completa — Dev Multy</h1>
            <p className="text-xs text-muted-foreground">
              Documento aggiornato: tutti i moduli, le regole e la troubleshooting rapida.
            </p>
          </div>
        </div>
        ...
        {loading && (
          <div className="flex items-center gap-3 py-12 justify-center text-muted-foreground">
            ...
            <span className="text-sm">Caricamento guida...</span>
          </div>
        )}

        {error && (
          <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/30 text-red-300 text-sm">
            Errore caricamento guida: {error}
          </div>
        )}
