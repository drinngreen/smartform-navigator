        ...
        <div className="flex items-center justify-between px-2">
          {guideSteps.map((s, i) => (
            <button key={i} onClick={() => setCurrentStep(i)} className="flex flex-col items-center">
              <div className={`w-12 h-12 rounded-full border-2 flex items-center justify-center mb-1 transition-all ${i === currentStep ? 'border-primary bg-primary/20 scale-110' : i < currentStep ? 'border-neon-green bg-neon-green/10' : 'border-border/30'}`}>
