...
export default function MNContextDashboardPage() {
    ...
    return (_jsxs(MNAdminLayout, { title: `${contextLabel} — ${firstName}`, subtitle: "Centro di Comando", children: [_jsxs("div", { className: "mb-4 flex items-center gap-4 p-3 rounded-2xl bg-gradient-to-r from-card/60 to-transparent border border-border/20 backdrop-blur-xl", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-2 h-2 rounded-full bg-neon-green animate-pulse" }), _jsx("span", { className: "text-xs font-mono uppercase tracking-wider text-white", children: "Sistema Operativo" })] }), _jsx("div", { className: "h-4 w-px bg-border/30" }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Signal, { className: "h-3.5 w-3.5 text-white animate-pulse" }), _jsx("span", { className: "text-xs font-mono text-white/80", children: "Connessione Stabile" })] }), _jsx("div", { className: "flex-1" }), _jsxs("div", { className: "flex items-center gap-2 text-xs font-mono text-white", children: [_jsx(Radio, { className: "h-3.5 w-3.5 animate-pulse" }), _jsx("span", { children: "LIVE DATA" })] })] }), _jsx(DesktopIconGrid, { icons: desktopIcons, storageKey: `desktop-icon-positions-mn-${context}` })] }));
}
