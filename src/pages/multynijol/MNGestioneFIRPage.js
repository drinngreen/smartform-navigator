...
import { Upload, RefreshCw, Database, Package, CheckCircle, Clock, AlertTriangle, Zap, XCircle, ChevronLeft, ChevronRight, Search, UserPlus, Users, Printer } from "lucide-react";
...
export default function MNGestioneFIRPage() {
    ...
    const handleInlineAssign = async (rowId, firNumber, targetUserId) => {
        try {
            const { error } = await supabase.rpc("create_manual_fir_draft_for_tenant", {
