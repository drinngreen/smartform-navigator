...
export default function MNTrasportatoriPage() {
    ...
    return (_jsxs(MNAdminLayout, { title: `Trasportatori ${tenant.label}`, subtitle: `Gestione trasportatori ${tenant.label}`, children: [_jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-3 mb-6", children: [
