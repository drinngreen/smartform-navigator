...
export default function MNDevAnalisiPage() {
    ...
    return (_jsxs(MNAdminLayout, { title: "\uD83D\uDD0D Analisi Prometeo", subtitle: "Confronto funzionalit\u00E0 Prometeo Rifiuti vs. piattaforma attuale", children: [_jsxs("div", { className: "mb-4 flex items-center justify-between gap-3 print:hidden", children: [_jsxs(Button, { variant: "ghost", onClick: () => navigate("/mn/admin/dev-multyproget"), className: "gap-2 text-muted-foreground hover:text-foreground", children: [_jsx(ArrowLeft, { size: 16 }), "Torna al Centro di Comando"] }), _jsxs(Button, { onClick: () => window.print(), className: "gap-2 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold shadow-lg", size: "lg", children: [_jsx(Printer, { size: 18 }), "\uD83D\uDDA8\uFE0F Stampa analisi"] })] }), _jsxs("div", { className: "rounded-2xl border border-border/40 bg-card/60 backdrop-blur-xl p-6 md:p-8 shadow-sm", children: [_jsxs("div", { className: "flex items-center gap-3 mb-6 pb-4 border-b border-border/30", children: [_jsx(BookOpen, { className: "h-6 w-6 text-emerald-400" }), _jsxs("div", { children: [_jsx("h1", { className: "text-lg font-semibold text-foreground", children: "Gap Analysis \u2014 Prometeo Rifiuti" }), _jsx("p", { className: "text-xs text-muted-foreground", children: "Stato di copertura di tutte le 8 aree funzionali richieste dal cliente." })] })] }), loading && (_jsxs("div", { className: "flex items-center gap-3 py-12 justify-center text-muted-foreground", children: [_jsx(Loader2, { className: "h-5 w-5 animate-spin" }), _jsx("span", { className: "text-sm", children: "Caricamento analisi..." })] })), error && (_jsxs("div", { className: "p-4 rounded-xl bg-red-500/10 border border-red-500/30 text-red-300 text-sm", children: ["Errore caricamento analisi: ", error] })), !loading && !error && (_jsx("article", { className: "prose prose-invert max-w-none text-sm text-foreground/90", children: _jsx(ReactMarkdown, { components: {
