...
const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Se il cliente non ha la PEC ma solo il codice destinatario SDI, scrivilo nel campo 'Codice SDI (fatturazione)': la PEC non è obbligatoria e lo SDI non va messo nelle note.",
  ...
  {
    id: "rentri-privati",
    title: "Invii RENTRI dei privati",
    subtitle: "Archivio invii da terminale e invio dall'app per i futuri conferimenti",
    image: "/tutorial/10-rentri-console.png",
    level: "Avanzato",
    minutes: 4,
    intro:
      "Novità di settembre 2026: nella Console RENTRI c'è una scheda dedicata agli invii dei conferimenti privati. Raccoglie tutti gli invii già fatti da terminale e permette di inviare i futuri conferimenti direttamente dall'app.",
    explain: [
      "Dove si trova: Console RENTRI → scheda «Invii privati». In alto un riepilogo con totale invii, kg complessivi, confermati, ancora aperti e quanti fatti da terminale.",
      "Ogni riga mostra data del movimento, data di invio, CER, kg, produttore, mezzo, progressivo RENTRI (es. 2026/1), identificativo transazione e identificativo ricevuta — entrambi copiabili con un tocco.",
      "L'etichetta di origine distingue chi ha fatto l'invio: gialla «Eseguito da terminale» per gli invii storici fatti dall'ufficio sul portale RENTRI, verde «Inviato dall'app» per quelli partiti dalla console.",
      "Lo stato dice se l'invio è andato a buon fine: Confermato (ricevuta RENTRI presente), In verifica (preso in carico, da ricontrollare), Da analizzare (errore o dato respinto).",
      "Il riquadro «Privati da inviare al RENTRI» in cima elenca i conferimenti privati registrati nel gestionale che non risultano ancora inviati. Si selezionano con le spunte e si inviano con «Invia selezionati»: l'app li manda al RENTRI attraverso il ponte sicuro e scrive da sola la riga nell'archivio con progressivo e ricevuta.",
      "Con il pulsante «Verifica» si ricontrolla una transazione già inviata dall'app: se il RENTRI ha confermato, lo stato passa a Confermato.",
      "Ricerca e filtri: si cerca per nome, CER, progressivo, ricevuta o mezzo; si filtra per mese e per origine. Tutto l'elenco si esporta in Excel o PDF.",
      "Questa scheda non tocca giacenze, cernite, registro privati né ricevute: scrive solo nel suo archivio dedicato.",
    ],
    steps: [
      "Apri la Console RENTRI e vai sulla scheda «Invii privati».",
      "Controlla il riepilogo in alto: quanti confermati e quanti ancora aperti.",
      "Se ci sono conferimenti nel riquadro «da inviare», selezionali e premi «Invia selezionati».",
      "Dopo l'invio verifica che lo stato passi da In verifica a Confermato (eventualmente con il pulsante «Verifica»).",
      "Per un controllo ispettivo usa ricerca, filtri e le esportazioni Excel/PDF.",
    ],
    warnings: [
      "Un invio «accettato» dal RENTRI non è ancora registrato: conta solo lo stato Confermato o la ricevuta.",
      "Se un conferimento risulta «da inviare» ma sai di averlo già trasmesso da terminale, non reinviarlo: segnalalo e va registrato nell'archivio con i dati della ricevuta.",
      "Attenzione ai pesi con la virgola: un invio con peso errato va stornato sul RENTRI, non «corretto» con un secondo invio.",
    ],
    faq: [
      { q: "Il riquadro «da inviare» è vuoto: è normale?", a: "Sì: significa che tutti i conferimenti privati registrati risultano già inviati. Si ripopola da solo quando entrano nuovi conferimenti non ancora trasmessi." },
      { q: "Manca la ricevuta di un invio fatto da terminale.", a: "Recupera progressivo e identificativo ricevuta dal portale RENTRI e falli registrare nella riga corrispondente dell'archivio: lo stato diventa Confermato." },
      { q: "Un invio resta «In verifica» da molto tempo.", a: "Usa il pulsante «Verifica» sulla riga: l'app interroga il RENTRI e aggiorna lo stato. Se resta fermo, segnala la transazione per un controllo sul ponte." },
    ],
    tip: "Prima di dire «i privati sono a posto», guarda il riepilogo: tutti confermati e riquadro «da inviare» vuoto è l'unica condizione davvero pulita.",
    route: "/mn/admin/dev-multyproget/rentri-console?tab=privati",
  },
  {
    id: "dark-lemon",
    title: "Dark Lemon AI",
    ...
    explain: [
      ...
      "Cosa può fare: cercare informazioni, preparare bozze FIR e proposte di correzione, assistere sulle pratiche RENTRI e compilare campi. Non può assegnare numeri ufficiali, confermare pesate, eseguire cernite, inviare a RENTRI o modificare giacenze senza conferma umana nel percorso previsto.",
