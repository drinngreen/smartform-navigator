...
function buildIcons(prefix: string): DesktopIconDef[] {
  return [
    ...
    { id: "magazzino", label: "Magazzino", iconImage: iconFatturazione, href: `${prefix}/magazzino`, color: "20, 184, 166" },
    { id: "conferimenti", label: "Conferimenti", iconImage: iconRegistroFir, href: `${prefix}/conferimenti`, color: "249, 115, 22" },
    { id: "impianti", label: "Impianti", iconImage: iconRentri, href: `${prefix}/impianti`, color: "59, 130, 246" },
