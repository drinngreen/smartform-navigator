import { accettaFirInArrivoDestinatario, isRentriOfflineResponse, listaFirInArrivoDestinatario, ricercaFir, firmaRicezione, } from "@/lib/rentriVpsApi";
...
export async function listIncomingXFir(cliente, identificativoSoggetto) {
    ...
    if (!res.success) {
        if (isRentriOfflineResponse(res))
            return [];
