...
export function listaFirInArrivoDestinatario(cliente, identificativoSoggetto) {
...
export function accettaFirInArrivoDestinatario(cliente, uuidFir, payload) {
    return inviaOperazioneRentriCustom(cliente, "POST", `/formulari/v1.0/${uuidFir}/accettazione`, payload);
}
