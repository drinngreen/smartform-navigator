...
export interface CodiceOperazione {
  codice: string;
  descrizione: string;
  tipo: "R" | "D";
}

export const CODICI_RECUPERO: CodiceOperazione[] = [
...
export const CODICI_SMALTIMENTO: CodiceOperazione[] = [
...
export function getCodiceOperazione(codice: string): CodiceOperazione | undefined {
...
export function labelCodiceOperazione(codice: string): string {
