...
import { Home, History, MapPin, Bot, User, HelpCircle } from "lucide-react";
import { cn } from "@/lib/utils";

interface MNBottomNavProps {
  basePath: string; // e.g. "/mn/app/multyproget" or "/mn/app/niyol"
}

export function MNBottomNav({ basePath }: MNBottomNavProps) {
  ...
  const navItems = [
    ...
    { icon: Bot, label: "DARK LEMON", href: `${basePath}/ai`, color: "59, 130, 246" },
