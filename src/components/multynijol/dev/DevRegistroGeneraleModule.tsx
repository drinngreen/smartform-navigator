...
// Colonne export/stampa richieste dal cliente: escluse le voci che rendevano
// la stampa illeggibile (n. movimento, +/-, qta scaricata, data ricezione,
// descrizione tipica, scaricato, cod. magazzino, peso lordo, tara, annotazioni,
// nota int., cod. intermediari, indirizzo intermediario, flagnimud, origine
// rifiuto, CONAI, att. orig. rif., pseudonimo cantiere, emissione formulario,
// form urbano, DDT ingresso, data DDT ingresso, respinto).
