        ...
        (async () => {
            try {
                if (store.editingFirId) {
                    ...
                    if (isTestFirNumberMN(store.data.selectedFirNumber) ||
