...
BEGIN
  ...
  IF NOT (auth.uid() = p_user_id OR public.is_multy_niyol_admin()) THEN
    RAISE EXCEPTION 'Non autorizzato';
  END IF;

  IF public.is_multy_niyol_admin() AND NOT public.is_allowed_multy_niyol_tenant(p_tenant_id) THEN
