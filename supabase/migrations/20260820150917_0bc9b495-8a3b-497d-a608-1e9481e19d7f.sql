ALTER TABLE public.privati_conferimenti ADD COLUMN IF NOT EXISTS prezzo_kg numeric;
...
BEGIN
  ...
  INSERT INTO public.ricevute_privati (
    ...
    v_anno, COALESCE(p_data, CURRENT_DATE),
    CASE WHEN v_somma_righe > 0 THEN v_somma_righe ELSE COALESCE(p_importo, 0) END,
    v_gruppo_id, v_note_finali
  );
